...
//---------------LIBRERÍAS---------------//
#include "engine/camera_06_02.hpp"
#include <glm/gtc/matrix_transform.hpp>
//---------------LIBRERÍAS---------------//

//-----------------------------------------------CONSTRUCTOR-----------------------------------------------//
Camera_06_02::Camera_06_02(const glm::vec3& position, const glm::vec3& up, float yaw, float pitch)
...
//-------------------------------------------------------CONSTRUCTOR-------------------------------------------------------//
Camera_06_02::Camera_06_02(float posX, float posY, float posZ, float upX, float upY, float upZ, float yaw, float pitch)
...
//-----------FUNCIÓN GETFOV-----------//
float Camera_06_02::getFOV() const {
    return _fov;
}
//-----------FUNCIÓN GETFOV-----------//

//-------------FUNCIÓN GETPOSITION-------------//
glm::vec3 Camera_06_02::getPosition() const {
    return _position;
}
//-------------FUNCIÓN GETPOSITION-------------//

//--------------------FUNCIÓN UPDATECAMERAVECTORS--------------------//
void Camera_06_02::updateCameraVectors() {
    glm::vec3 front;
...
void Camera_06_02::handleKeyboard(Movement direction, float dt) {
...
void Camera_06_02::handleMouseMovement(float xoffset, float yoffset, bool constrainPitch) {
...
void Camera_06_02::handleMouseScroll(float yoffset) {
