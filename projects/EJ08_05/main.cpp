...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light,
	const Texture& t_albedo, const Texture& t_specular, const Texture& t_specular_2) {
	...
	t_specular_2.use(s_phong, "material.specular", 1);
...
int main(int, char* []) {
	...
	const Texture t_specular_2("../assets/textures/bricks_specular_2.png", Texture::Format::RGB);// Textura specular 2
	...
	while (window->alive()) {
		...
		render(sphere, sphere, s_phong, s_light, t_albedo, t_specular, t_specular_2);			// Se renderiza la esfera y la luz
