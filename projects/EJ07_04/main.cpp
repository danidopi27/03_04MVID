...
void render(const Geometry& object, const Geometry& light, const Shader& s_gouraud, const Shader& s_light) {
	...
	glm::mat3 normalMat = glm::inverse(glm::transpose(glm::mat3(model)));								// Transformación espacio model
...
int main(int, char* []) {
	...
	const Shader s_phong("../projects/EJ07_04/gouraud.vs", "../projects/EJ07_04/gouraud.fs");	// Carga del shader de phong
	const Shader s_light("../projects/EJ07_04/light.vs", "../projects/EJ07_04/light.fs");		// Carga del shader de light
