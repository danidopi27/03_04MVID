...
int main(int, char* []) {
	...
	const Shader shader("../projects/EJ04_02/vertex.vs", "../projects/EJ04_02/fragment.fs");	// Carga de los shaders
	...
	while (window->alive()) {
		...
		render(VAO, shader, tex1);																// Se renderiza el VAO, shader y textura
