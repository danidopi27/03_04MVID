...
int main(int, char* []) {
	...
	const Shader s_phong("../projects/EJ08_03/phong.vs", "../projects/EJ08_03/blinn.fs");		// Carga del shader de phong
	const Shader s_light("../projects/EJ08_03/light.vs", "../projects/EJ08_03/light.fs");		// Carga del shader de light
	...
	while (window->alive()) {
		...
		render(sphere, sphere, s_phong, s_light, t_albedo, t_specular);							// Se renderiza la esfera y la luz
