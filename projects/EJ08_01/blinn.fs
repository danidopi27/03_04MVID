/*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  DESCRIPCI�N: Blinn.fs del ejercicio 8_01
...
void main() {
    vec3 ambient = material.ambient * light.ambient;								// C�lculo del ambiente
    ...
    vec3 diffuse = diff * material.diffuse * light.diffuse;											// C�lculo de la difusi�n
    ...
    vec3 specular = spec * material.specular * light.specular;					// Composici�n de componente especular
