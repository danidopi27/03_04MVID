...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light) {
	...
	s_phong.use();
	model = glm::mat4(1.0f);
	model = glm::translate(model, glm::vec3(-1.0f, 0.0f, 0.0f));										// Esfera a la izquierda
	...
	// Material perla
	s_phong.set("material.ambient", 0.25f, 0.20725f, 0.20725f);
	s_phong.set("material.diffuse", 1.0f, 0.829f, 0.829f);
	s_phong.set("material.specular", 0.296648f, 0.296648f, 0.296648f);
	s_phong.set("material.shininess", 0.088f * 64);
	...
	s_phong.use();
	model = glm::mat4(1.0f);
	model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));											// Esfera en el centro
	s_phong.set("model", model);
	s_phong.set("view", view);
	s_phong.set("proj", proj);
	...
	// Material bronce
	s_phong.set("material.ambient", 0.2125f, 0.1275f, 0.054f);
	s_phong.set("material.diffuse", 0.714f, 0.4284f, 0.18144f);
	s_phong.set("material.specular", 0.393548f, 0.271906f, 0.166721f);
	s_phong.set("material.shininess", 0.2f * 64);
	...
	s_phong.use();
	model = glm::mat4(1.0f);
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));											// Esfera a la derecha
	s_phong.set("model", model);
	s_phong.set("view", view);
	s_phong.set("proj", proj);
	...
	// Material goma cian
	s_phong.set("material.ambient", 0.0f, 0.05f, 0.05f);
	s_phong.set("material.diffuse", 0.4f, 0.5f, 0.5f);
	s_phong.set("material.specular", 0.04f, 0.7f, 0.7f);
...
int main(int, char* []) {
	...
	const Sphere sphere(0.4f, 50, 50);															// Creación de esfera
