...
int main(int, char* []) {
    ...
    const Shader s_phong("../projects/EJ12_02/phong.vs", "../projects/EJ12_02/blinn.fs");		// Carga del shader de phong
    const Shader s_normal("../projects/EJ12_02/normal.vs", "../projects/EJ12_02/normal.fs");	// Carga del shader de normal
	...
	const Model model("../assets/models/Freighter/Freigther_BI_Export.obj");					// Creación del modelo
	...
	while (window->alive()) {
        ...
        render(model, s_phong, s_normal, t_albedo, t_specular, t_normal);						// Se renderiza
