...
//############################################################################## DEFINICIÓN .HPP ##############################################################################//
#ifndef __CAMERA_FINAL_H__
#define __CAMERA_FINAL_H__
...
class Camera_FINAL {
    ...
    public:
		...
		Camera_FINAL(const glm::vec3& position = glm::vec3(0.0f, 0.0f, 0.0f), const glm::vec3& up = glm::vec3(0.0f, 1.0f, 0.0f), float yaw = k_Yaw, float pitch = k_Pitch);
		Camera_FINAL(float posX, float posY, float posZ, float upX, float upY, float upZ, float yaw, float pitch);
