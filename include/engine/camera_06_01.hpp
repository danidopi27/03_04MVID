...
//############################################################################## DEFINICIÓN .HPP ##############################################################################//
#ifndef __CAMERA_06_01_H__
#define __CAMERA_06_01_H__
...
class Camera_06_01 {
    ...
    public:
        ...
        Camera_06_01(const glm::vec3& position = glm::vec3(0.0f, 0.0f, 0.0f), const glm::vec3& up = glm::vec3(0.0f, 1.0f, 0.0f), float yaw = k_Yaw, float pitch = k_Pitch);
        Camera_06_01(float posX, float posY, float posZ, float upX, float upY, float upZ, float yaw, float pitch);
